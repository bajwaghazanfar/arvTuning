...
import {
  ...
  financeFormAnimation,
  exploreMoreAnimation,
} from "./animations";
...
const RemappingPage = () => {
  ...
  var introText =
    "We offer various Stage 1 and Stage 2 remaps for various cars. ";
  ...
  return (
    <>
      ...
      <Helmet>
        <meta charSet="utf-8" />
        <title>ARV TUNING|REMAPPING</title>
        <meta
          name="description"
          content="Desire a remap? Want to unlock the full potential of your car at ARV TUNING today! "
        />
      </Helmet>
      <div className={styles.container} ref={container}>
        ...
        <div className={styles.financeFormContainer} ref={financeFormContainer}>
          <div className={styles.financeFormHeader}>
            ...
            <h3>
              {" "}
              Fill out the remapping form below and a member of our team will be
              in touch with you.
            </h3>
          </div>
          <div className={styles.financeFormWrapper}>
            <div className={styles.financeFormImage}>
              ...
              <div
                className={styles.financeFormImageAfter}
                ref={financeFormImageAfter}
              />
            </div>
              ...
              <form onSubmit={onSumbit}>
                ...
                <div className={styles.inputField}>
                  ...
                  <select
                    ...
                    required="true"
                    defaultValue="Select Stage Type"
                  >
                    <option value="default" selected>
                      Select In House HQ or Mobile Service
                    </option>
                ...
                <div className={styles.inputField}>
                  ...
                  <select name="stageType" required="true">
                    ...
                    <option value="Stage 1 + Speed limit remove">
                      Stage 1 + speed limit remove
                    </option>
                    <option value="Stage 2 + Speed limit remove">
                      Stage 2 + speed limit remove
                    </option>
                ...
                <div className={styles.inputField}>
                  ...
                  <input
                    ...
                    required="true"
                    name="Enquires"
                    placeholder="Type any additional enquires here"
                  />
                </div>
                ...
                <div
                  ...
                  style={emailOK ? { opacity: 1 } : { opacity: 0 }}
                >
